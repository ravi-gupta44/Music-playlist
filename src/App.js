...
class App extends Component {
  ...
  deleteSongItemCard = id => {
    ...
    const filteredDeleteItems = TrackList.filter(eachSong => eachSong.id !== id)
    this.setState({TrackList: filteredDeleteItems})
  }
    ...
    return (
      <div className="app-container">
        ...
        <div className="input-search-card">
          <div className="input-search-card">
            <h1 className="input-search-name">Songs Playlist</h1>
            <div className="input-card">
              ...
              />
              <button className="input-search-btn" type="button">
          ...
          <ul className="songs-list-card">
            {searchList.map(eachItem => (
              <SongItem
                ...
                deleteSongItemCard={this.deleteSongItemCard}
              />
            ))}
          </ul>
        ) : (
